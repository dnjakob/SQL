...
/*!50001 VIEW `orders_view` AS select `orders`.`id` AS `id`,`orders`.`customer_id` AS `customer_id`,`orders`.`shipped_date` AS `shipped_date`,`orders`.`ship_name` AS `ship_name`,`orders`.`ship_city` AS `ship_city`,`orders`.`ship_state_province` AS `ship_state_province` from `orders` */;
...
-- Dump completed on 2024-03-22 10:02:05
